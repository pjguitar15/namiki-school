...
const DEFAULT_COPY: Required<
  Omit<
    ...
    'ctaHref' | 'imageSrc' | 'reverse' | 'isImageRounded'
  >
> = {
  eyebrow: {
    ja: 'モンテッソーリ教育',
        ...
        <Container className='py-0'>
          <div
            className={`grid items-center gap-10 md:gap-12 ${
              reverse
                ? 'md:grid-cols-[1.45fr_0.9fr]'
                : 'md:grid-cols-[0.9fr_1.45fr]'
            }`}
          >
            ...
            <div
              className={`relative h-[280px] overflow-hidden md:h-[430px] lg:h-[520px] ${reverse ? 'md:order-1' : ''}`}
            >
              <div
                className='relative h-full w-full overflow-hidden'
                style={{
                  borderRadius: isImageRounded
