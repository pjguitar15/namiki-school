  ...
  const copy =
    language === "ja"
      ? {
          ...
          featuredLabel: "おすすめ",
          note:
            "入会金はプログラムによって異なります。通常デイケア（8:00〜17:00）は ¥50,000、10:00〜15:00デイケア・アフタースクールは ¥30,000、短時間デイケアは ¥40,000、英会話は ¥15,000（いずれも初回のみ）です。",
          plans: [
            {
      ...
      : {
          ...
          note:
            "Admission fees vary by program: full-day daycare (8:00-17:00) is ¥50,000, 10:00-15:00 daycare and after-school are ¥30,000, short-hour daycare is ¥40,000, and Eikaiwa is ¥15,000 (all one-time).",
          plans: [
            {
